...
type MiniDesiredLRP struct {
	ProcessGuid             string                     `protobuf:"bytes,1,opt,name=process_guid,json=processGuid,proto3" json:"process_guid"`
	Domain                  string                     `protobuf:"bytes,2,opt,name=domain,proto3" json:"domain"`
	Instances               int32                      `protobuf:"varint,4,opt,name=instances,proto3" json:"instances"`
	Routes                  *Routes                    `protobuf:"bytes,5,opt,name=routes,proto3,customtype=Routes" json:"routes,omitempty"`
	LogGuid                 string                     `protobuf:"bytes,6,opt,name=log_guid,json=logGuid,proto3" json:"log_guid"`
	ModificationTag         *ModificationTag           `protobuf:"bytes,7,opt,name=modification_tag,json=modificationTag,proto3" json:"modification_tag,omitempty"`
	MetricTags              map[string]*MetricTagValue `protobuf:"bytes,8,rep,name=metric_tags,json=metricTags,proto3" json:"metric_tags,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Setup                   *Action                    `protobuf:"bytes,9,opt,name=setup,proto3" json:"setup,omitempty"`
	Action                  *Action                    `protobuf:"bytes,10,opt,name=action,proto3" json:"action,omitempty"`
	Monitor                 *Action                    `protobuf:"bytes,11,opt,name=monitor,proto3" json:"monitor,omitempty"`
	DeprecatedStartTimeoutS uint32                     `protobuf:"varint,12,opt,name=deprecated_start_timeout_s,json=deprecatedStartTimeoutS,proto3" json:"start_timeout,omitempty"` // Deprecated: Do not use.
	StartTimeoutMs          int64                      `protobuf:"varint,13,opt,name=start_timeout_ms,json=startTimeoutMs,proto3" json:"start_timeout_ms"`
	CachedDependencies      []*CachedDependency        `protobuf:"bytes,14,rep,name=cached_dependencies,json=cachedDependencies,proto3" json:"cached_dependencies,omitempty"`
	ImageLayers             []*ImageLayer              `protobuf:"bytes,15,rep,name=image_layers,json=imageLayers,proto3" json:"image_layers,omitempty"`
...
func (m *MiniDesiredLRP) Reset()      { *m = MiniDesiredLRP{} }
func (*MiniDesiredLRP) ProtoMessage() {}
func (*MiniDesiredLRP) Descriptor() ([]byte, []int) {
	return fileDescriptor_f592e9299b63d68c, []int{7}
}
func (m *MiniDesiredLRP) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MiniDesiredLRP) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MiniDesiredLRP.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MiniDesiredLRP) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MiniDesiredLRP.Merge(m, src)
}
func (m *MiniDesiredLRP) XXX_Size() int {
	return m.Size()
}
func (m *MiniDesiredLRP) XXX_DiscardUnknown() {
	xxx_messageInfo_MiniDesiredLRP.DiscardUnknown(m)
}

var xxx_messageInfo_MiniDesiredLRP proto.InternalMessageInfo

func (m *MiniDesiredLRP) GetProcessGuid() string {
	if m != nil {
		return m.ProcessGuid
	}
	return ""
...
func (m *MiniDesiredLRP) GetDomain() string {
	if m != nil {
		return m.Domain
	}
	return ""
...
func (m *MiniDesiredLRP) GetInstances() int32 {
	if m != nil {
		return m.Instances
	}
	return 0
...
func (m *MiniDesiredLRP) GetLogGuid() string {
	if m != nil {
		return m.LogGuid
	}
	return ""
...
func (m *MiniDesiredLRP) GetModificationTag() *ModificationTag {
	if m != nil {
		return m.ModificationTag
	}
	return nil
...
func (m *MiniDesiredLRP) GetMetricTags() map[string]*MetricTagValue {
	if m != nil {
		return m.MetricTags
	}
	return nil
...
func (m *MiniDesiredLRP) GetSetup() *Action {
	if m != nil {
		return m.Setup
	}
	return nil
...
func (m *MiniDesiredLRP) GetAction() *Action {
	if m != nil {
		return m.Action
	}
	return nil
...
func (m *MiniDesiredLRP) GetMonitor() *Action {
	if m != nil {
		return m.Monitor
	}
	return nil
...
// Deprecated: Do not use.
func (m *MiniDesiredLRP) GetDeprecatedStartTimeoutS() uint32 {
	if m != nil {
		return m.DeprecatedStartTimeoutS
	}
	return 0
...
func (m *MiniDesiredLRP) GetStartTimeoutMs() int64 {
	if m != nil {
		return m.StartTimeoutMs
	}
	return 0
...
func (m *MiniDesiredLRP) GetCachedDependencies() []*CachedDependency {
	if m != nil {
		return m.CachedDependencies
	}
	return nil
...
func (m *MiniDesiredLRP) GetImageLayers() []*ImageLayer {
	if m != nil {
		return m.ImageLayers
	}
	return nil
...
// Deprecated: Do not use.
func (m *MiniDesiredLRP) GetLegacyDownloadUser() string {
	if m != nil {
		return m.LegacyDownloadUser
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*MiniDesiredLRP)(nil), "models.MiniDesiredLRP")
	proto.RegisterMapType((map[string]*MetricTagValue)(nil), "models.MiniDesiredLRP.MetricTagsEntry")
}
...
var fileDescriptor_f592e9299b63d68c = []byte{
	...
	,
}
...
func (this *MiniDesiredLRP) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*MiniDesiredLRP)
	if !ok {
		that2, ok := that.(MiniDesiredLRP)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *MiniDesiredLRP) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 19)
	s = append(s, "&models.MiniDesiredLRP{")
	s = append(s, "ProcessGuid: "+fmt.Sprintf("%#v", this.ProcessGuid)+",\n")
	s = append(s, "Domain: "+fmt.Sprintf("%#v", this.Domain)+",\n")
	s = append(s, "Instances: "+fmt.Sprintf("%#v", this.Instances)+",\n")
	s = append(s, "Routes: "+fmt.Sprintf("%#v", this.Routes)+",\n")
...
func (m *MiniDesiredLRP) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MiniDesiredLRP) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MiniDesiredLRP) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MiniDesiredLRP) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *MiniDesiredLRP) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForCachedDependencies := "[]*CachedDependency{"
	...
	mapStringForMetricTags += "}"
	s := strings.Join([]string{`&MiniDesiredLRP{`,
		`ProcessGuid:` + fmt.Sprintf("%v", this.ProcessGuid) + `,`,
		`Domain:` + fmt.Sprintf("%v", this.Domain) + `,`,
		`Instances:` + fmt.Sprintf("%v", this.Instances) + `,`,
		`Routes:` + fmt.Sprintf("%v", this.Routes) + `,`,
...
func (m *MiniDesiredLRP) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MiniDesiredLRP: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MiniDesiredLRP: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
